...
create index ix_handover_categories_owner_created
    on handover_categories(owner_id, created_at, id);
...
create index ix_handovers_owner_updated
    on handovers(owner_id, updated_at desc, id asc);
